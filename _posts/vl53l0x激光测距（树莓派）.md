...
index_img: https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/04/image-32.png
tags: []
id: '1531'
categories:
  - - 树莓派
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/04/image-32.png)
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/04/image-31-1024x535.png)
...
换个安装方法，上[GitHub](https://github.com/pimoroni/VL53L0X-python)一搜，果然有源码安装方法
    ...
    cd your\_directory#选择你的目录
    git clone https://github.com/pimoroni/VL53L0X\_rasp\_python.git
    cd VL53L0X-python
    make

然后在VL53L0X-python文件夹中，有一个VL53L0X\_example.py，就是样例代码，能跑通就可以了
