...
#### IOU
真实框和预测框之间的交并比。
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/4.png)
#### 精确度
预测为正例的那些数据里预测正确的比例。
#### 召回率
真实为正例的那些数据里预测正确的比例。
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/18.png)
#### MAP
MAP是不同类别的平均AP。
## YOLOv1
...
**思考一个问题：** 怎么表示一个位置框(目标)？
x,y,w,h,conf,class
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/7.png)
### 核心思想
...
### 网络结构
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/19.png)
输入：448\*448\*3<br>
经过卷积池化卷积池化...全连接<br>
输出：7\*7\*30<br>
7\*7：格子<br>
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/20.png)
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/17.png)
### 总结
优点：快速，简单
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/21.png)
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/22.png)
### 多尺度训练
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/23.png)
最后一层的感受野太大了，容易丢失小目标，所以需要融合之前的特征层，reshape后叠加。
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/24.png)
### 网络结构
采用了Darknet19网络结构，实际的size和图不一样。
输入416\*416\*3,输出13\*13\*1024
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/25.png)
### 总结
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/26.png)
### 网络结构
主干网络:全卷积网络DarkNet-53，53层卷积层。
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/28.png)
#### 残差连接
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/27.png)
### 多scale特征融合
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/29.png)
### 先验框更丰富
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/30.png)
训练集真实框做kmeans聚类,k=9,按大小再分三类，用不同的特征图预测。
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/31.png)
### 预测多标签任务
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/32.png)

![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/33.png)
### Bag of specoals
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/34.png)
#### SPPF
SPPF串联使用了池化层，使得计算效率更高。
将两个5×5的池化层进行串联等价于使用一个9×9的最大池化，而使用3个5×5的最大池化又等价于一个13×13的最大池化。
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/35.png)
### 数据增强策略
Mosaic（图像拼接）
...
与yolov5的对比
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/36.png)
### decoupled head
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/37.png)
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/38.png)
### anchor-free
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/40.png)
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/42.png)
因此如上图所示：
...
#### SimOTA
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/43.png)
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/46.png)
### 结论
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/20221010/45.png)
### 现有YOLO的问题
