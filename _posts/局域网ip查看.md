...
![](https://xinhaojin.github.io/imgs-host/past/2021/04/image.png)

记住前3个数，那么我们要找的局域网内其他设备的IP基本上就是192.168.54.xxx

输入for /L %i IN (1,1,254) DO ping -w 2 -n 1 192.168.54.%i，等待运行完成

![](https://xinhaojin.github.io/imgs-host/past/2021/04/image-2.png)

输入arp -a，查看局域网内其它设备的IP，其中192.168.54.xxx的，且物理地址不全为f的，就是要找的设备

![](https://xinhaojin.github.io/imgs-host/past/2021/04/image-4.png)
