...
index_img: https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/12/image-3.png
tags: []
id: '2107'
categories:
  - - 爬虫
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/12/image-3.png)
...
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/12/image-4.png)
    ...
    request({
        ...
        if (!error && response.statusCode == 200) {
            ...
            $('\[data-detection-rate\]').each(function (i, elem) {
                detection\_rate\[i\] = $(this).text();
            });
            console.log(positive);
            console.log(death);
            console.log(detection\_rate);
        }
    });
}
```
![](https://cdn.staticaly.com/gh/xinhaojin/imgs-host@master/past/2021/12/image-5-1024x241.png)